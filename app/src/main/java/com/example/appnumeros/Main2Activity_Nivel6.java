...
public class Main2Activity_Nivel6 extends AppCompatActivity {
    ...
    public void NumAleatorio(){
        if(puntaje<=100){
            ...
            if(numAleatorio_uno >= 0 && numAleatorio_uno <=2){
                resultado = numAleatorio_uno + numAleatorio_dos;
                imgsigno.setImageResource(R.drawable.suma);
            } else if (numAleatorio_uno >= 3 && numAleatorio_uno <=5){
                resultado = numAleatorio_uno - numAleatorio_dos;
                imgsigno.setImageResource(R.drawable.resta);
            } else {
                resultado = numAleatorio_uno * numAleatorio_dos;
                imgsigno.setImageResource(R.drawable.multiplicacion);
            }
            ...
            Toast.makeText(this,"Finalisaste el juego....¡Felicidades!",Toast.LENGTH_SHORT).show();
            startActivity(intent);
            finish();
        }
    }
